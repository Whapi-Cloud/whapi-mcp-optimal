...
module.exports = async function checkPhones(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/contacts";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('force_check')) bodyObj['force_check'] = args['force_check'];
